...
import com.example.raytine.keepmoving.home.tabUi.CheckoutFragment;
import com.example.raytine.keepmoving.home.tabUi.HotelManageFragment;
import com.example.raytine.keepmoving.home.tabUi.SearchFragment;
...
public class HomeFragment extends Fragment {
    ...
    private void initViewList() {
        viewList.add(new HotelManageFragment());
        viewList.add(new SearchFragment());
        viewList.add(new CheckoutFragment());
    }
